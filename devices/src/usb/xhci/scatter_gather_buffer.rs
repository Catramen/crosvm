...
use super::xhci_abi::{NormalTrb, TransferDescriptor, TrbCast, TrbType};
...
impl ScatterGatherBuffer {
    ...
    pub fn read(&self, buffer: &mut [u8]) -> usize {
        ...
        for atrb in &self.td {
            ...
            total_size += self
                .mem
                .read_slice_at_addr(cur_buffer, GuestAddress(normal_trb.get_data_buffer()))
                .unwrap();
        }
        total_size
    }
    ...
    pub fn write(&self, buffer: &[u8]) -> usize {
        ...
        for atrb in &self.td {
            ...
            total_size += self
                .mem
                .write_slice_at_addr(cur_buffer, GuestAddress(normal_trb.get_data_buffer()))
                .unwrap();
        }
        total_size
    }
