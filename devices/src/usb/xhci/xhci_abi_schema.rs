...
// Schema of disable slot command trb.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
...
// Schema of address device command trb.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
...
// Schema of configure endpoint command trb.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
...
// Schema of evaluated context command trb.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
...
// Schema of command completion event trb.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
...
// Schema of port status change evnet trb.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
...
// Schema of event ring segment table entry trb.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
...
// Schema of input control context.
#[derive(BitField)]
#[passthrough(derive(Clone, Copy))]
